...
{
    var reader = ApiReader(join(pkgPath, 'tool', 'protocol_spec', 'spec_input.html'));
...
class ApiReader
{
    ...
    Domain domainFromHtml(dom.Element html)
    {
        ...
        return Domain(name, requests, notifications, html, experimental: experimental);
    }
    ...
    Notification notificationFromHtml(dom.Element html, String context)
    {
        ...
        checkAttributes(html, ['event'], context, optionalAttributes: ['experimental']);
        var experimental = html.attributes['experimental'] == 'true';

        return Notification(domainName, event, params, html, experimental: experimental);
    }
    ...
    List<TypeDecl> processContentsAsTypes(dom.Element html, String context)
    {
        ...
        recurse(html, context, {
            ...
            'map': (dom.Element child)
            {
                ...
                recurse(child, context, {
                    ...
                    'value': (dom.Element child)
                    {
                        ...
                        valueTypeNullable =
                            processContentsAsType(child, '$context.value');
                    }
                });
            ...
            'union': (dom.Element child)
            {
                ...
                types
                    .add(TypeUnion(processContentsAsTypes(child, context), field, child));
            }
        });
        return types;
    }
