...
class CodeGenerator
{
    ...
    String collectCode(void Function() callback, {bool removeTrailingNewLine = false})
    {
        var oldState = _state;
        try
        {
    ...
    /// [additionalIndent].
    void indentSpecial(
        String firstAdditionalIndent, String additionalIndent, void Function() callback)
    {
 ...
 * To regenerate the file, use the script "tool/protocol_spec/generate.dart".
 */''';
        }
...
class GeneratedFile extends GeneratedContent
{
    ...
    @override
    File output(String pkgPath) => File(join(pkgPath, joinAll(posix.split(outputPath))));
}
