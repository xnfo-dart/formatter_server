...
class Api extends ApiNode
{
    ...
    Api(this.version, this.domains, this.types, this.refactorings, dom.Element html,
...
class Refactorings extends ApiNode with IterableMixin<Refactoring>
{
    ...
    Refactorings(this.refactorings, dom.Element? html, {bool experimental = false})
        : super(html, experimental: experimental, deprecated: false);
...
class Request extends ApiNode
{
    ...
    Request(this.domainName, this.method, this.params, this.result, dom.Element html,
        {bool experimental = false, bool deprecated = false})
        : super(html, experimental: experimental, deprecated: deprecated);
...
{
    TypeDecl(dom.Element? html, {bool experimental = false, bool deprecated = false})
        : super(html, experimental: experimental, deprecated: deprecated);
...
class TypeMap extends TypeDecl
{
    ...
    TypeMap(this.keyType, this.valueType, dom.Element html, {bool experimental = false})
        : super(html, experimental: experimental, deprecated: false);
...
class TypeUnion extends TypeDecl
{
    ...
    TypeUnion(this.choices, this.field, dom.Element html, {bool experimental = false})
        : super(html, experimental: experimental, deprecated: false);
