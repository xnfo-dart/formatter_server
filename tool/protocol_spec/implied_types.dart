...
class ImpliedType
{
    ...
    ImpliedType(
        this.camelName, this.humanReadableName, this.type, this.kind, this.apiNode);
}
...
class _ImpliedTypesVisitor extends HierarchicalApiVisitor
{
    ...
    void visitRefactoring(Refactoring refactoring)
    {
        ...
        storeType(camelKind, 'feedback', refactoring.feedback, 'refactoringFeedback',
            refactoring);
        storeType(
            camelKind, 'options', refactoring.options, 'refactoringOptions', refactoring);
    }

    @override
    void visitRequest(Request request)
    {
        storeType(request.longMethod, 'params', request.params, 'requestParams', request);
        storeType(request.longMethod, 'result', request.result, 'requestResult', request);
    }
