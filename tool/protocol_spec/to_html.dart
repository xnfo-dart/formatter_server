...
mixin HtmlMixin
{
    ...
    void link(String id, void Function() callback, [Map<Object, String>? attributes])
    {
        attributes ??= {};
        attributes['href'] = '#$id';
...
class ToHtmlVisitor extends HierarchicalApiVisitor with HtmlMixin, HtmlGenerator
{
    ...
    void visitTypeDefinition(TypeDefinition typeDefinition)
    {
        ...
        dt(typeDefinition.deprecated ? 'typeDefinition deprecated' : 'typeDefinition', ()
        {
...
class TypeVisitor extends HierarchicalApiVisitor with HtmlMixin, HtmlCodeGenerator
{
    ...
    TypeVisitor(Api api, {this.fieldsToBold = const {}, this.short = false}) : super(api);
