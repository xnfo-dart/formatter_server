...
//    new Future(() => notificationController.add(notification));
    ...
    Future<Response> waitForResponse(Request request, {bool throwOnError = true})
    {
        // TODO(brianwilkerson) Attempt to remove the `throwOnError` parameter and
        // have the default behavior be the only behavior.
        var id = request.id;
...
class TestPluginManager implements PluginManager
{
    ...
    StreamController<void> pluginsChangedController = StreamController.broadcast();
    ...
    @override
    Map<PluginInfo, Future<plugin.Response>> broadcastRequest(plugin.RequestParams params,
    ...
    @override
    Future<List<Future<plugin.Response>>> broadcastWatchEvent(WatchEvent watchEvent) async
    {
    ...
    @override
    void setAnalysisSetPriorityFilesParams(plugin.AnalysisSetPriorityFilesParams params)
    {
        analysisSetPriorityFilesParams = params;
    }

    @override
    void setAnalysisSetSubscriptionsParams(plugin.AnalysisSetSubscriptionsParams params)
    {
        analysisSetSubscriptionsParams = params;
    }

    @override
    void setAnalysisUpdateContentParams(plugin.AnalysisUpdateContentParams params)
    {
