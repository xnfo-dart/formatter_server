...
import '../formatter_server_base.dart';
import '../mocks.dart';
...
*/
    //TODO(tekert) test RequestErrorCode.FORMAT_RANGE_ERROR
...
''');
        ...
        ], excluded: []);
        {
            ...
            await handleSuccessfulRequest(
                ServerUpdateContentParams({aaa.path: AddContentOverlay('void f() {}')})
                    .toRequest('0'),
            );
...
/*
    Future<void> test_sentToPlugins() async
    {
        ...
        //
        await handleSuccessfulRequest(
            ServerUpdateContentParams(<String, Object>{
                filePath: AddContentOverlay(fileContent),
            }).toRequest('0'),
        );
        var params = pluginManager.ServerUpdateContentParams!;
        ...
        // Change
        //
        pluginManager.ServerUpdateContentParams = null;
        await handleSuccessfulRequest(
            ServerUpdateContentParams(<String, Object>{
        ...
        params = pluginManager.ServerUpdateContentParams!;
