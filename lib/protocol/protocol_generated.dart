  ...
  factory EditFormatParams.fromJson(
    ...
    if (json is Map) {
      ...
      if (json.containsKey('tabSize')) {
        tabSize = TabSize.fromJson(
            jsonDecoder, jsonPath + '.tabSize', json['tabSize']);
      }
      bool? insertSpaces;
...
class TabSize implements HasToJson {
  ...
  TabSize(
      this.block, this.cascade, this.expression, this.constructorInitializer);

  factory TabSize.fromJson(
      JsonDecoder jsonDecoder, String jsonPath, Object? json) {
    json ??= {};
    if (json is Map) {
      int block;
      ...
      if (json.containsKey('constructorInitializer')) {
        constructorInitializer = jsonDecoder.decodeInt(
            jsonPath + '.constructorInitializer',
            json['constructorInitializer']);
      } else {
